# Duncan Bennett's Personal Website
## Workflow
+ Under the Pages setting on your github.io repo, set the option to have the website build from <code> /docs </code>.
+ On your machine, build the webiste with <code> hugo -d docs </code> then add, commit and push
